...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/jessicatinguely/blogpessoal_spring) dentro da pasta do *Workspace* do STS
 
```bash

git clone https://github.com/jessicatinguely/blogpessoal_spring.git
...
Desenvolvido por [**Jessica**](https://github.com/jessicatinguely)
