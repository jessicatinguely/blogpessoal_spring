...
public class Tema {
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "tema", cascade = CascadeType.REMOVE) // UM TEMA PARA MUITAS
																						// POSTAGENS, CASCADE REMOVE
																						// PARA DELETAR AS POSTAGENS
																						// RELACIONADAS AO TEMA
	@JsonIgnoreProperties(value = "tema", allowSetters = true)
	// IGNORA OS GETS MAS PERMITE OS SETS (POST, PUT), OU SEJA, NÃO RETORNA AS
	// POSTAGENS MAS PERMITE QUE SEJA ATRIBUÍDA UM TEMA A UMA POSTAGEM
